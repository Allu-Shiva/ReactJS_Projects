...
class AllProductsSection extends Component {
  ...
  renderNoProductsView = () => (
    <div className="no-products-container">
      ...
      />
      <p className="no-products-heading">No Products Found</p>
  ...
  renderFailureView = () => (
    <div className="no-products-container">
      ...
      />
      <p className="no-products-heading">Oops! Something Went Wrong</p>
      <p className="no-products-text">
  ...
  onCategorySelect = id => this.setState({category: id}, this.getProducts)

  onRatingSelect = id => this.setState({rating: id}, this.getProducts)
  ...
  onUserSearch = title => this.setState({titleSearch: title}, this.getProducts)
